...
<div class="not-prose my-12 rounded-2xl bg-gradient-to-br from-primary-50 to-primary-100 border border-primary-200 p-8 sm:p-10 text-center shadow-sm">
  <h3 class="text-primary-900 text-2xl font-bold mb-3">Are You Using All Your Insurance Benefits?</h3>
  <p class="text-gray-600 mb-6 max-w-lg mx-auto">Get a free review of your supplementary insurance — we'll identify unused perks and recommend optimizations.</p>
