...
<div class="cta-box bg-primary-50 border-primary-500 p-6 my-8 rounded-lg text-center">
  <h3 class="text-primary-800 text-xl font-bold mb-3">IPMI vs Swiss Supplementary — We'll Run the Numbers</h3>
  <p class="mb-4">We compare exact costs for your age, health profile, and travel patterns — across both Swiss and international options. Free, independent advice.</p>
  <a href="/free-consultation" class="btn btn-primary px-6 py-2 rounded-md font-medium">Book Your Free Insurance Comparison</a>
</div>
