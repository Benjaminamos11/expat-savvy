...
<div class="not-prose my-12 rounded-2xl bg-gradient-to-br from-primary-50 to-primary-100 border border-primary-200 p-8 sm:p-10 text-center shadow-sm">
  <h3 class="text-primary-900 text-2xl font-bold mb-3">Get Your Personalized Hospital Insurance Quote</h3>
  <p class="text-gray-600 mb-6 max-w-lg mx-auto">We compare semi-private and private premiums across all major insurers for your age and canton — and maximize your acceptance chances.</p>
