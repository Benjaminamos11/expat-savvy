---
title: "3rd Pillar for Self-Employed in Switzerland | Expert Guide 2026"
description: "Self-employed without a 2nd pillar? Contribute up to CHF 35,280/year tax-free. Expert guidance on the 4 mistakes that cost self-employed expats thousands."
...
faqs:
  - question: "How much can self-employed contribute to 3rd pillar?"
    answer: "Self-employed without a 2nd pillar can contribute up to 20% of net earned income, maximum CHF 35,280 for 2026. With a 2nd pillar, the limit is CHF 7,056 — the same as employed persons."
  - question: "Can self-employed open multiple 3a accounts?"
    answer: "Yes, and you should. The staggering strategy — 4-5 accounts withdrawn in different tax years — saves CHF 5,000-15,000 in withdrawal taxes. This is even more valuable for self-employed given higher balances."
  - question: "Which 3a provider is best for self-employed?"
    answer: "finpension (0.39% fees) and VIAC (0.44%) are top choices. For large contributions, finpension's slightly lower fee compounds to significant savings. Both offer 97-99% equity allocations for long horizons."
  - question: "Can I deduct 3a contributions if I'm self-employed part of the year?"
    answer: "Yes, but the 20% limit applies to your net self-employment income for the year. If you switched from employed to self-employed mid-year, the calculation gets complex — consult a tax advisor."
---
...
For the full picture of how 3a tax deductions work, see our [3rd pillar tax savings guide](/guides/how-to/save-taxes-with-3a-pillar/).
...
The [staggering strategy](/blog/third-pillar-maximize-2026-tax-benefits/) — opening 4–5 separate 3a accounts and withdrawing them across different tax years — is valuable for everyone. But it's **dramatically more valuable** for self-employed persons with larger balances.
...
For a detailed fee comparison, see [VIAC vs Frankly vs finpension](/blog/viac-vs-frankly-vs-finpension-comparison/) and [bank vs insurance 3a](/3rd-pillar/bank-vs-insurance/).
...
1. **BVG vs 3a optimization** — Should you join a voluntary BVG, contribute CHF 35,280 to 3a, or combine both? This depends on income, age, canton, and existing coverage.
2. **Contribution splitting** — If your income varies year to year, how do you optimize contributions across good and bad years?
3. **Exit planning** — If you plan to leave Switzerland or retire, the withdrawal sequence for self-employed is more complex than for employed persons. See our [leaving Switzerland pension guide](/blog/leaving-switzerland-pension-withdrawal-guide/).
4. **Company structure** — If you're considering incorporating (GmbH/AG), the pension strategy changes entirely. Time your 3a contributions around any structural change.
...
For the complete 3rd pillar overview, visit our [3rd pillar hub page](/3rd-pillar/).
...
<div class="not-prose my-12 rounded-2xl bg-slate-50 border border-slate-200 p-8 sm:p-10 text-center">
  <h3 class="text-slate-900 text-2xl font-bold mb-3">Self-Employed? Your 3a Strategy Needs Expert Input</h3>
  <p class="text-gray-600 mb-6 max-w-lg mx-auto">The difference between a good and great 3a strategy is worth CHF 50,000+ over your career. Our FINMA-certified planners optimize your contribution, provider, and withdrawal timing.</p>
  <button onclick="window.openContextualModal('blog')" class="inline-flex items-center gap-2 px-8 py-4 bg-red-600 hover:bg-red-700 text-white text-lg font-semibold rounded-xl transition-all duration-200 shadow-sm hover:shadow-md cursor-pointer">
    ...
    Book Your Free Self-Employed 3a Review
  </button>
