---
title: "Unhappy With Your Swiss Health Insurance? Here's What You Can Do"
description: "Slow claims, no English, surprise bills — you have options. How to fix, switch, or complain about your Swiss health insurer. Free expert review available."
author: "Benjamin Amos Wagner"
date: 2026-03-29
tags: ["health insurance", "switch insurer", "insurance complaints", "expat guide", "customer service", "2026 guide"]
image: "https://res.cloudinary.com/dphbnwjtx/image/upload/f_auto,q_auto/v1747075365/a-stylized-hand-drawn-sketch-in-red-and-_0X-QLYauSvagbqHWT_YNQg_mxoIrEg6QS6ES0zn0FS9Qw_hlo3lx.webp"
---
...
**What to do:**
1. Request a detailed explanation from your insurer — they must explain why something wasn't covered
2. Check if the treatment is on the [TARMED catalog](https://www.bag.admin.ch) — if it's listed, basic insurance must cover it
3. If you disagree, file a written objection within 30 days
4. Contact the Ombudsman if the insurer doesn't respond satisfactorily
...
Read our [premium comparison by canton](/blog/cheapest-health-insurance-switzerland-2026) for current data.
...
1. **Compare premiums** — use [our comparison](/healthcare/best-health-insurance-switzerland/) or the [BAG premium calculator](https://www.priminfo.admin.ch)
2. **Choose new insurer** — apply online or through a broker
3. **Send cancellation letter** — must reach current insurer by **30 November** (send registered mail by mid-November)
4. **New policy starts** — automatically on 1 January
5. **No gap in coverage** — legally impossible

### Supplementary Insurance (VVG)

1. **Apply to new insurer first** — submit health questionnaire
2. **Wait for written acceptance** — this can take 1–4 weeks
3. **Only then cancel** your current supplementary insurance
4. **Timing:** Check your current policy's cancellation terms (usually 3 months before renewal)
5. **Never cancel before acceptance** — you could end up with no supplementary coverage
...
- **How:** [ombudsman-kv.ch](https://www.ombudsman-kv.ch) — available in German, French, Italian
- **Cost:** Free
...
**Q: Can my insurer refuse to cover a treatment my doctor prescribed?**
For basic insurance: they can only refuse if the treatment isn't in the TARMED catalog or isn't "medically necessary" according to the WZW criteria (efficacy, appropriateness, cost-effectiveness). If your doctor prescribed it, there's usually a strong case for coverage. Dispute it in writing.

**Q: I want to switch but I'm worried about the transition. What if something goes wrong?**
For basic insurance, nothing can go wrong. Swiss law guarantees continuous coverage. Your new insurer must accept you — no health questions, no waiting periods, no exclusions. The transition is seamless.

**Q: My insurer rejected my supplementary insurance claim. What can I do?**
Request a written explanation with specific policy clause references. Check if the clause actually applies to your situation. If you disagree, write a formal objection. If that fails, contact the Ombudsman. Many rejected claims are overturned on review.
...
- [Cheapest Health Insurance by Canton](/blog/cheapest-health-insurance-switzerland-2026)
...
<div class="not-prose my-12 rounded-2xl bg-gradient-to-br from-primary-50 to-primary-100 border border-primary-200 p-8 sm:p-10 text-center shadow-sm">
  <h3 class="text-primary-900 text-2xl font-bold mb-3">Ready for a Better Insurance Experience?</h3>
  <p class="text-gray-600 mb-6 max-w-lg mx-auto">We review your current coverage, compare all options, and handle the switching process — at no cost to you.</p>
