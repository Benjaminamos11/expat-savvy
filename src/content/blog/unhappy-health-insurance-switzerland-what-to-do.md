...
<div class="cta-box bg-primary-50 border-primary-500 p-6 my-8 rounded-lg text-center">
  <h3 class="text-primary-800 text-xl font-bold mb-3">Ready for a Better Insurance Experience?</h3>
  <p class="mb-4">We review your current coverage, compare all options, and handle the switching process — at no cost to you.</p>
