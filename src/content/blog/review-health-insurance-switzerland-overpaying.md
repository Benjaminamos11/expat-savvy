...
<div class="cta-box bg-primary-50 border-primary-500 p-6 my-8 rounded-lg text-center">
  <h3 class="text-primary-800 text-xl font-bold mb-3">Find Out If You're Overpaying</h3>
  <p class="mb-4">Free 20-minute review with a FINMA-certified advisor. We check your premium, franchise, model, and supplementary coverage against all 50+ Swiss insurers.</p>
